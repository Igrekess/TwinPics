...
set {createdByLabel, theTop} to create label "* created by yan senez - 2024 - v 0.1 - yansenez.com *" bottom (0) max width accViewWidth control size small size aligns center aligned without bold type
